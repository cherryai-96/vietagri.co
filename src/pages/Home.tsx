      ...
      <section className="py-24 bg-cream border-t border-gold-warm/15 px-4 md:px-8 overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col items-center relative group">
          ...
          <div className="flex flex-col items-center text-center gap-4 mb-12">
            ...
            <h2 className="font-serif text-[2rem] leading-[1.1] sm:text-3xl md:text-3xl lg:text-3xl xl:text-[2.5rem] font-bold tracking-wide text-forest leading-tight w-full lg:whitespace-nowrap"><span dangerouslySetInnerHTML={{ __html: t('home.spotlightTitle') }} /></h2>
          </div>

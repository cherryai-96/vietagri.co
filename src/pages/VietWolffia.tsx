    ...
    <div className="font-sans overflow-hidden">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center bg-carbon text-cream pt-32 pb-16 px-4 md:px-8">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10 flex flex-col items-center gap-6">
          ...
          >
            ...
            <h1 className="font-serif text-[2.75rem] leading-[1.1] sm:text-[3.5rem] md:text-6xl lg:text-7xl font-bold leading-tight tracking-wide text-gold-champagne"><span dangerouslySetInnerHTML={{ __html: t('wolffia.heroTitle') }} /></h1>
          </motion.div>
      ...
      <section className="py-24 bg-cream text-carbon px-4 md:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-7 flex flex-col gap-6">
            <h2 className="font-serif text-[2.5rem] leading-[1.1] sm:text-5xl md:text-6xl font-bold text-forest leading-tight"><span dangerouslySetInnerHTML={{ __html: t('wolffia.introTitle') }} /></h2>
      ...
      <section className="py-24 bg-cream text-carbon px-4 md:px-8 border-y border-gold-warm/15">
        <div className="max-w-6xl mx-auto flex flex-col gap-16">
          <div className="text-center max-w-3xl mx-auto flex flex-col gap-4">
            ...
            <h2 className="font-serif text-[2.75rem] leading-[1.1] sm:text-[3.5rem] md:text-6xl lg:text-7xl font-bold tracking-wide text-forest leading-tight"><span dangerouslySetInnerHTML={{ __html: t('wolffia.cultTitle') }} /></h2>
            <p className="text-sm md:text-base text-carbon/75 font-light leading-relaxed">
              {t('wolffia.cultDesc')}
            </p>
          </div>
      ...
      <section className="py-24 bg-cream text-carbon px-4 md:px-8">
        <div className="max-w-7xl mx-auto flex flex-col gap-16">
          <div className="text-center max-w-3xl mx-auto flex flex-col gap-4">
            ...
            <h2 className="font-serif text-[2.75rem] leading-[1.1] sm:text-[3.5rem] md:text-6xl lg:text-7xl font-bold tracking-wide text-forest leading-tight"><span dangerouslySetInnerHTML={{ __html: t('wolffia.appTitle') }} /></h2>
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-12">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
            <div className="flex flex-col gap-3">
              ...
              <h2 className="font-serif text-[2.5rem] leading-[1.1] sm:text-5xl md:text-6xl font-bold text-forest"><span dangerouslySetInnerHTML={{ __html: t('wolffia.galleryTitle') }} /></h2>
            </div>
      ...
      <section className="py-24 bg-brown-soil text-cream relative px-4 md:px-8 border-t border-gold-warm/25">
        <div className="max-w-4xl mx-auto text-center flex flex-col gap-8 items-center">
          <h2 className="font-serif text-[2.75rem] leading-[1.1] sm:text-[3.5rem] md:text-6xl lg:text-7xl font-bold text-gold-champagne leading-tight"><span dangerouslySetInnerHTML={{ __html: t('wolffia.ctaTitle') }} /></h2>

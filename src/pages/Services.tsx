    ...
    <div className="font-sans overflow-hidden">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center bg-carbon text-cream pt-32 pb-16 px-4 md:px-8">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10 flex flex-col items-center gap-6">
          ...
          >
            ...
            <h1 className="font-serif text-[2.75rem] leading-[1.1] sm:text-[3.5rem] md:text-6xl lg:text-7xl font-bold leading-tight tracking-wide text-gold-champagne"><span dangerouslySetInnerHTML={{ __html: t('services.heroTitle') }} /></h1>
          </motion.div>
      ...
      <section className="py-16 bg-cream text-carbon px-4 md:px-8">
        <div className="max-w-4xl mx-auto text-center flex flex-col gap-6">
          <h2 className="font-serif text-[2.5rem] leading-[1.1] sm:text-5xl md:text-6xl font-bold text-forest leading-tight"><span dangerouslySetInnerHTML={{ __html: t('services.introTitle') }} /></h2>
      ...
      <section className="py-24 text-cream relative px-4 md:px-8 border-t border-gold-warm/25 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center flex flex-col gap-8 items-center relative z-10">
          <h2 className="font-serif text-[2.75rem] leading-[1.1] sm:text-[3.5rem] md:text-6xl lg:text-7xl font-bold text-gold-champagne leading-tight"><span dangerouslySetInnerHTML={{ __html: t('services.ctaTitle') }} /></h2>

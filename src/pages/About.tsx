      ...
      <section className="relative min-h-[60vh] flex items-center justify-center bg-carbon text-cream pt-32 pb-16 px-4 md:px-8">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10 flex flex-col items-center gap-6">
          ...
          >
            ...
            <h1 className="font-serif text-3xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-wide text-gold-champagne"><span dangerouslySetInnerHTML={{ __html: t('about.heroTitle') }} /></h1>
          </motion.div>
      ...
      <section className="py-24 bg-cream text-carbon px-4 md:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-8 order-1 lg:order-2">
            ...
            >
              <h2 className="font-serif text-2xl md:text-4xl font-bold text-forest border-b border-gold-warm/25 pb-4"><span dangerouslySetInnerHTML={{ __html: t('about.missionTitle') }} /></h2>
            ...
            <motion.div
              ...
              className="bg-ivory border border-gold-warm/15 rounded-xl p-8 lg:p-12 flex flex-col gap-6 shadow-sm"
            >
              <h2 className="font-serif text-2xl md:text-4xl font-bold text-forest border-b border-gold-warm/25 pb-4"><span dangerouslySetInnerHTML={{ __html: t('about.visionTitle') }} /></h2>
              <p className="text-sm md:text-base text-carbon/75 font-light leading-relaxed">
                {t('about.visionDesc')}
              </p>
            </motion.div>
      ...
      <section className="py-24 bg-ivory text-carbon px-4 md:px-8 border-y border-gold-warm/15">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 flex flex-col gap-6">
            ...
            <h2 className="font-serif text-3xl md:text-4xl font-bold text-forest leading-tight"><span dangerouslySetInnerHTML={{ __html: t('about.footprintTitle') }} /></h2>
            <p className="text-sm md:text-base text-carbon/75 font-light leading-relaxed">
      ...
      <section className="py-24 bg-cream text-carbon px-4 md:px-8">
        <div className="max-w-7xl mx-auto flex flex-col gap-16">
          <div className="text-center max-w-3xl mx-auto flex flex-col gap-4">
            ...
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold tracking-wide text-forest leading-tight"><span dangerouslySetInnerHTML={{ __html: t('about.whyTitle') }} /></h2>
          </div>

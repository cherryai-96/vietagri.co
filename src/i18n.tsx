...
export const defaultResources: TranslationResources = {
 en: {
  ...
  products: {
   ...
   input1Desc: 'A cutting-edge microbial activator that shifts soil microorganisms into an aerobic metabolism through the application of specific, selective bio-energy.',
 ...
 vi: {
  ...
  products: {
   ...
   input1Desc: 'Một chất kích hoạt vi sinh vật tiên tiến chuyển đổi vi sinh vật trong đất sang chuyển hóa hiếu khí thông qua việc áp dụng năng lượng sinh học chọn lọc, đặc hiệu.',

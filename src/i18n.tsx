...
export const defaultResources: TranslationResources = {
 en: {
  ...
  training: {
    ...
    benefit1Desc: 'Leverage VAC’s verified supplier network, 100+ catalogue products, and packaging infrastructure without initial capital outlay.',
    benefit2Title: 'Lucrative Trade Commissions',
    benefit2Desc: 'Earn attractive, transparent commission structures on every successful export shipment facilitated through your buyer connections.',
    benefit3Title: 'On-the-Ground Trade Liaison',
    benefit3Desc: 'VAC agronomists and compliance experts handle factory audits, samples, phytosanitary papers, and ocean freight logistics.',
    benefit4Title: 'Continuous Mentorship',
    benefit4Desc: 'Receive ongoing guidance from seasoned international trade directors and access VAC’s proprietary buyer CRM tools.',
 ...
 vi: {
  ...
  training: {
    ...
    benefit1Desc: 'Khai thác mạng lưới nhà cung ứng đã kiểm định, 100+ sản phẩm catalogue và hạ tầng đóng gói của VAC mà không cần vốn ban đầu.',
    benefit2Title: 'Hoa Hồng Thương Mại Hấp Dẫn',
    benefit2Desc: 'Hưởng cơ chế hoa hồng rõ ràng, minh bạch trên mỗi đơn hàng xuất khẩu thành công được kết nối.',
    benefit3Title: 'Đội Ngũ Thực Địa & Hậu Cần Hỗ Trợ',
    benefit3Desc: 'Đội ngũ kỹ sư agronomist và chuyên gia pháp lý VAC đảm nhận audit nhà máy, chuẩn bị hồ sơ kiểm dịch và vận tải biển.',
    benefit4Title: 'Đồng Hành & Cố Vấn Thường Xuyên',
    benefit4Desc: 'Nhận sự cố vấn trực tiếp từ các giám đốc thương mại quốc tế và sử dụng công cụ CRM kết nối người mua của VAC.',

      ...
      >
        <div className="w-full px-2 lg:px-4 xl:px-6 mx-auto flex justify-between items-center">
          ...
          <div className="flex flex-col whitespace-nowrap">
            <span className="font-serif font-bold uppercase text-lg sm:text-xl md:text-2xl lg:text-xl xl:text-2xl text-cream tracking-wide leading-none transition-colors duration-300">

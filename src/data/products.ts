...
export interface CategoryInfo {
  ...
  availableCutsKo?: string[];
  availableCutsJa?: string[];
  defaultPackagingEn: string;
  defaultPackagingVi: string;
  defaultPackagingZh?: string;
  defaultPackagingKo?: string;
  defaultPackagingJa?: string;
  storageEn: string;
  storageVi: string;
  storageZh?: string;
  storageKo?: string;
...
export const CATEGORIES_DATA: Record<string, CategoryInfo> = {
  'fresh': {
    ...
    highlightsKo: ['MRL 및 잔류 농약 기준 엄격 준수', '지속적인 콜드체인 관리 (REEFER 컨테이너 +2°C ~ +13°C)', '수확 후 검역 처리 인증 (VHT 훈증 / 방사선 처리)', '맞춤형 통풍 수출 포장 (통풍 상자 / 플라스틱 상자)'],
    highlightsJa: ['MRLおよび残留農薬基準の厳格な 준수', '継続的なコールドチェーン管理（REEFERコンテナ +2℃〜+13℃）', '収穫後検疫処理認証（VHT蒸気熱処理／照射処理）', 'カスタム通気輸出包装（通気段ボール／プラスチックトレイ）'],
  ...
  'powders': {
    ...
    highlightsKo: ['4가지 핵심 제조 기술 (동결건조, 열풍건조, 분무건조, 추출)', '100% 천연, 인공 색소 및 보존제 무첨가', '미세 입자 입도 (80-100 메쉬)', 'RTD 음료 및 보충제용 고수용성 제형'],
    highlightsJa: ['4つの核心製造技術（フリーズドライ、熱風乾燥、スプレードライ、エキス抽出）', '100％天然、人工着색料・保存料不使用', '標準メッシュサイズ（80〜100メッシュ）', '即飲RTD飲料やサプリメント用の高水溶性フォーミュラ'],
  ...
  'freeze-dried': {
    ...
    highlightsKo: ['영양소와 구조를 보존하는 승화 동결건조 기술', '낮은 수분 함량(< 5%)으로 18-24개월 상온 보관 가능', '100% 과일 원물, 미튀김, 설탕 및 보존제 무첨가', '다양한 절단 형태: 통원물, 슬라이스, 다이스, 크리스프'],
    highlightsJa: ['栄養素と構造を維持する昇華フリーズドライ技術', '超低水分量（< 5%）により常温で18〜24ヶ月長期間保存可能', '100%果実、ノンフライ、砂糖・人工保存料不使用', '多彩なカット形状：ホール、スライス、ダイス、クリスプ'],
  ...
  'iqf': {
    ...
    highlightsKo: ['-35°C 초고속 냉동으로 세포 구조 및 해동 후 드립 방지', '100% 낱개 떼어짐 (Free-flowing) 포장', '엄격한 미생물 제어 및 금속 검출기 전수 검사', '다양한 절단 규격 (다이스, 하프, 슬라이스, 퓨레 블록)'],
    highlightsJa: ['-35℃超急速凍結による細胞保持と解凍時のドリップ抑制', '100％バラ凍結（Free-flowing）で自動投入に対応', '厳格な微生物管理と金属検出器による全品検査', '豊富なカット形態（ダイス、ハーフ、スライス、ホール、ピューレブロック）'],
  ...
  'purees': {
    ...
    highlightsKo: ['100% 천연 생과일 원료, 설탕 및 합성 보존제 무첨가', '무균 공정 및 순간 살균으로 과일 본연의 향과 색상 유지', 'Brix(°Bx), pH, 과육 함량의 엄격한 규격화', '다양한 규격: 씨 포함/제거 퓨레, 1배 착즙 원액, 고농축액'],
    highlightsJa: ['100％天然生果実原料、砂糖・人工保存料不使用', '無菌加工・瞬時高温殺菌による鮮やかな色と風味の維持', 'Brix（糖度）、pH、パルプ分の厳密な標準化', '柔軟な規格：種入り／種抜きピューレ、ストレート果汁、高濃縮液'],
  ...
  'seafood': {
    ...
    highlightsKo: ['HACCP, BRCGS, ISO 및 Halal 인증 가공 시설', '항생제 및 중금속 잔류물 엄격 검사', '지속적인 -18°C 초저온 콜드체인 유지', '다양한 수출 규격 (필렛, 스테이크, PTO, 노바시, 링, 꼬치)'],
    highlightsJa: ['HACCP、BRCGS、ISOおよびハラール認証加工工場', '抗生物質および重金属残留の厳格な検査', '-18℃連続深冷凍コールドチェーンの徹底', '多彩な輸出加工規格（フィレ、ステイク、PTO、伸長エビ、イカリング、串焼き）'],
  ...
  'crops-plant-based': {
    ...
    highlightsKo: ['GlobalG.A.P 및 VietGAP 농장 추적성', '5가지 가공 규격 (신선, 분말, 퓨레/원액, 동결건조, IQF)', '콜드체인 및 수확 후 검역 처리 인증 (VHT/방사선)', '맞춤형 B2B 산업 포장 및 OEM 브랜딩'],
    highlightsJa: ['GlobalG.A.PおよびVietGAP農場のトレーサビリティ', '5大加工規格（生果、パウダー、ピューレ／果汁、FD、IQF）', '認証コールドチェーン＆収穫後処理（VHT／照射）', 'カスタムB2B産業用包装およびOEMプライベートブランド'],
  ...
  'poultry': {
    ...
    highlightsKo: ['생물안전 양계 및 조류독감 무발생 인증', 'Halal 및 ISO 인증 도계 및 가공', '-35°C 급속 터널 냉동 및 초저온 보관', '도매상 및 가공 공장용 맞춤형 벌크 포장'],
    highlightsJa: ['バイオセキュア養鶏＆鳥インフルエンザ非発生認証', 'ハラールおよびISO認証屠殺・加工', '-35℃トンネル急速凍結および深冷凍保管', '卸売業者および加工工場向けカスタムバルク包装'],
  ...
  'basa': {
    ...
    highlightsKo: ['HACCP, BRCGS, ISO 및 Halal 인증 시설', 'ASC / BAP 인증 지속 가능한 양식 조달', '100% 백색육, 항생제 및 화학 잔류물 zero 보장', 'IQF 개별 급속 냉동 및 글레이징 맞춤 설정 (0-20%)'],
    highlightsJa: ['HACCP、BRCGS、ISOおよびハラール認証工場', 'ASC／BAP認証の持続可能な水産養殖調達', '100％白身肉、抗生物質・化学残留物ゼロ保証', 'IQF単体急速凍結およびグレーズ率カスタム（0〜20％）'],
  ...
  'shrimp': {
    ...
    highlightsKo: ['ASC/BAP 인증 농장의 블랙타이거 및 흰다리새우', '완전한 추적성 및 무질병 생물안전성', '부가가치 가공 규격 (노바시, 버터플라이, 튀김용)', '정밀 중량 선별 및 IQF 급속 냉동 품질'],
    highlightsJa: ['ASC/BAP認証養殖場のブラックタイガー＆バナメイエビ', '完全なトレーサビリティと無病原体バイオセキュリティ', '高付加価値加工規格（ノバシ、バタフライ、天ぷら衣付き）', '精密なサイズ選別とIQF品質'],
  ...
  'squid': {
    ...
    highlightsKo: ['100% 원양 천연 수산물로 깊은 단맛 보유', '입항 직후 즉시 가공으로 쫄깃한 식감 보존', '맞춤형 절단 (솔방울/솔잎 컷, 링, 튜브, 꼬치)', 'EU 및 미국 FDA 등록 수출 가공 시설'],
    highlightsJa: ['100％遠洋天然海鮮で高い天然の甘み', '水揚げ直後の加工による歯ごたえの維持', 'カスタムカット（松笠カット、リング、ツボ抜き、串焼き）', 'EUおよび米国FDA登録済みの輸出加工工場'],
...
export const PRODUCTS_LIST: ProductItem[] = [
  // === POULTRY PRODUCTS ===
  {
    ...
    nameZh: '清真整鸡 (去内脏·烧烤级)',
    nameKo: '할랄 인증 냉동 통닭 (도계 완료)',
    nameJa: 'ハラール認証 冷凍丸鶏（内臓除去済み）',
  ...
  },
  {
    ...
    nameKo: '무뼈 껍질제거 닭가슴살 필렛',
    nameJa: '骨なし皮なし 鶏胸肉フィレ',
    scientificName: 'Gallus gallus domesticus',
    category: 'poultry',
    subCategory: 'Chicken Cuts',
  ...
  },
  {
    ...
    nameKo: '냉동 닭 장각/후腿 (Leg Quarters)',
    nameJa: '冷凍 骨付き鶏腿肉（レッグクォーター）',
    scientificName: 'Gallus gallus domesticus',
    category: 'poultry',
    subCategory: 'Chicken Cuts',
  ...
  },
  {
    ...
    nameKo: '냉동 닭 넓적다리/마달 (Thighs)',
    nameJa: '冷凍 鶏サイ・腿肉（Thighs）',
    scientificName: 'Gallus gallus domesticus',
    category: 'poultry',
    subCategory: 'Chicken Cuts',
  ...
  },
  {
    ...
    nameKo: '냉동 닭 북채/북봉 (Drumsticks)',
    nameJa: '冷凍 鶏ドラムスティック（Drumsticks）',
    scientificName: 'Gallus gallus domesticus',
    category: 'poultry',
    subCategory: 'Chicken Cuts',
  ...
  },
  {
    ...
    nameZh: '冷冻切段鸡翅 (翅中 & 翅根)',
    nameKo: '냉동 윙봉 & 윙렛 (Cuts)',
    nameJa: '冷凍 切断手羽（手羽中・手羽元）',
    scientificName: 'Gallus gallus domesticus',
    category: 'poultry',
    subCategory: 'Chicken Cuts',
  ...
  },
  {
    ...
    nameKo: '수출용 냉동 닭발 & 족발 (Feet & Paws)',
    nameJa: '輸出用 冷凍モミジ・鶏足（Feet & Paws）',
    scientificName: 'Gallus gallus domesticus',
    category: 'poultry',
  ...
  },
  {
    ...
    nameKo: '냉동 닭 내장 (근위·간·염통)',
    nameJa: '冷凍 鶏内臓（砂肝・レバー・ハツ）',
    scientificName: 'Gallus gallus domesticus',
    category: 'poultry',
    subCategory: 'Chicken By-Products',
  ...
  },
  {
    ...
    nameZh: '鸡肉香肠 & 炸鸡系列',
    nameKo: '치킨 소시지 & 크리스피 치킨',
    nameJa: 'チキンソーセージ＆衣付きチキン',
    scientificName: 'Gallus gallus domesticus',
    category: 'poultry',
    subCategory: 'Chicken Cuts',
  ...
  // === BASA FISH (PANGASIUS) PRODUCTS ===
  {
    ...
    nameKo: '바사 피쉬 필렛 (Well-Trimmed 정미)',
    nameJa: 'パンガシウス・バサフィレ（精修・皮骨除去）',
  ...
  },
  {
    ...
    nameKo: '바사 피쉬 필렛 (Untrimmed 원형)',
    nameJa: 'パンガシウス・バサフィレ（脂肪残し未精修）',
    scientificName: 'Pangasius hypophthalmus',
    category: 'basa',
    subCategory: 'Basa Fish — Pangasius',
  ...
  },
  {
    ...
    nameZh: '冷冻整条巴沙鱼 (原条)',
    nameKo: '냉동 통 바사 피쉬 (원물)',
    nameJa: '냉동 통 바사 피쉬 (원물)',
    scientificName: 'Pangasius hypophthalmus',
    category: 'basa',
    subCategory: 'Basa Fish — Pangasius',
  ...
  },
  {
    ...
    nameKo: '냉동 머리/내장 제거 바사 (H&G)',
    nameJa: '冷凍 去頭去内臓バサ（H&G）',
    scientificName: 'Pangasius hypophthalmus',
    category: 'basa',
    subCategory: 'Basa Fish — Pangasius',
  ...
  },
  {
    ...
    nameKo: '냉동 바사 피쉬 스테이크/토막',
    nameJa: '冷凍 バサ・ステッキカット（Steak）',
    scientificName: 'Pangasius hypophthalmus',
    category: 'basa',
    subCategory: 'Basa Fish — Pangasius',
  ...
  },
  {
    ...
    nameKo: '냉동 바사 복육/뱃살 (Belly Strips)',
    nameJa: '冷凍 バサ・ハラス・腹肉（Belly Strips）',
    scientificName: 'Pangasius hypophthalmus',
    category: 'basa',
    subCategory: 'Basa Fish — Pangasius',
  ...
  },
  {
    ...
    nameKo: '튀김용 빵가루 바사 필렛',
    nameJa: 'フライ用衣付きバサフィレ（Breaded）',
    scientificName: 'Pangasius hypophthalmus',
    category: 'basa',
    subCategory: 'Basa Fish — Pangasius',
  ...
  },
  {
    ...
    nameKo: '바사 피쉬핑거 (Fish Fingers)',
    nameJa: 'バサ・フィッシュスティック（Fish Fingers）',
    scientificName: 'Pangasius hypophthalmus',
    category: 'basa',
    subCategory: 'Basa Fish — Pangasius',
  ...
  // === VIETNAMESE SHRIMP PRODUCTS ===
  {
    ...
    nameKo: '흰다리새우 HOSO (머리/껍질 포함)',
    nameJa: 'バナメイエビ HOSO（有頭・殻付き）',
  ...
  },
  {
    ...
    nameKo: '흰다리새우 HLSO (머리 제거 껍질 포함)',
    nameJa: 'バナメイエビ HLSO（無頭・殻付き）',
    scientificName: 'Litopenaeus vannamei',
    category: 'shrimp',
    subCategory: 'Vietnamese Shrimp',
  ...
  },
  {
    ...
    nameKo: '흰다리새우 PDTO (탈각 꼬리 남김)',
    nameJa: 'バナメイエビ PDTO（保尾むき身）',
    scientificName: 'Litopenaeus vannamei',
    category: 'shrimp',
    subCategory: 'Vietnamese Shrimp',
  ...
  },
  {
    ...
    nameKo: '흰다리새우 P&D / PUD (완전 탈각)',
    nameJa: 'バナメイエビ P&D / PUD（完全むき身）',
    scientificName: 'Litopenaeus vannamei',
    category: 'shrimp',
    subCategory: 'Vietnamese Shrimp',
  ...
  },
  {
    ...
    nameKo: '자숙 칵테일 새우 (Cooked Cocktail)',
    nameJa: 'ボイルむき身カクテルエビ（Cocktail）',
    scientificName: 'Litopenaeus vannamei',
    category: 'shrimp',
    subCategory: 'Vietnamese Shrimp',
  ...
  },
  {
    ...
    nameKo: '버터플라이 컷 새우 (Butterfly)',
    nameJa: 'バタフライカットエビ（Butterfly）',
    scientificName: 'Litopenaeus vannamei',
    category: 'shrimp',
    subCategory: 'Vietnamese Shrimp',
  ...
  },
  {
    ...
    nameKo: '블랙타이거 HOSO (머리/껍질 포함)',
    nameJa: 'ブラックタイガー HOSO（有頭・殻付き）',
  ...
  },
  {
    ...
    nameKo: '블랙타이거 PDTO (탈각 꼬리 남김)',
    nameJa: 'ブラックタイガー PDTO（保尾むき身）',
    scientificName: 'Penaeus monodon',
    category: 'shrimp',
    subCategory: 'Vietnamese Shrimp',
  ...
  },
  {
    ...
    nameKo: '튀김용 빵가루/덴푸라 새우',
    nameJa: 'パン粉フライ・天ぷら用エビ',
    scientificName: 'Litopenaeus vannamei',
    category: 'shrimp',
    subCategory: 'Vietnamese Shrimp',
  ...
  },
  {
    ...
    nameKo: '일식 노바시 튀김용 새우 (Nobashi)',
    nameJa: '和食用伸しエビ（ノバシエビ）',
    scientificName: 'Litopenaeus vannamei',
    category: 'shrimp',
    subCategory: 'Vietnamese Shrimp',
  ...
  },
  {
    ...
    nameKo: '양념 새우 꼬치 (Shrimp Skewers)',
    nameJa: '味付けエビ串（Shrimp Skewers）',
    scientificName: 'Litopenaeus vannamei',
    category: 'shrimp',
    subCategory: 'Vietnamese Shrimp',
  ...
  },
  {
    ...
    nameKo: '리테일팩 냉동 모듬 해산물 새우',
    nameJa: 'リテール用冷凍ミックスシーフード・エビ',
    scientificName: 'Litopenaeus vannamei',
    category: 'shrimp',
    subCategory: 'Vietnamese Shrimp',
  ...
  // === SQUID & CALAMARI PRODUCTS ===
  {
    ...
    nameKo: '원양 원물 오징어 (Whole Round)',
    nameJa: '天然原条イカ（Whole Round）',
  ...
  },
  {
    ...
    nameKo: '내장 제거 세척 오징어 (Cleaned)',
    nameJa: '下処理済み天然イカ（Whole Cleaned）',
  ...
  },
  {
    ...
    nameKo: '무피 냉동 오징어 튜브 (Tubes)',
    nameJa: '皮むき冷凍イカ筒・チューブ（Tubes）',
    scientificName: 'Photololigo edulis',
    category: 'squid',
    subCategory: 'Squid & Calamari',
  ...
  },
  {
    ...
    nameKo: 'IQF 냉동 오징어 링 (Rings)',
    nameJa: 'IQF急速冷凍イカリング（Rings）',
    scientificName: 'Photololigo edulis',
    category: 'squid',
    subCategory: 'Squid & Calamari',
  ...
  },
  {
    ...
    nameKo: '냉동 세척 오징어 다리 (Tentacles)',
    nameJa: '下処理済みイカゲソ・下足（Tentacles）',
    scientificName: 'Photololigo edulis',
    category: 'squid',
    subCategory: 'Squid & Calamari',
  ...
  },
  {
    ...
    nameKo: '냉동 오징어 지느러미 / 스트립',
    nameJa: '冷凍イカ耳・短冊カット（Squid Wings）',
    scientificName: 'Photololigo edulis',
    category: 'squid',
    subCategory: 'Squid & Calamari',
  ...
  },
  {
    ...
    nameKo: '파인애플 솔방울 컷 오징어 필렛',
    nameJa: '松笠・パイナップルカットイカフィーレ',
    scientificName: 'Photololigo edulis',
    category: 'squid',
    subCategory: 'Squid & Calamari',
  ...
  },
  {
    ...
    nameZh: '日式照烧/炭烤鱿鱼切块',
    nameKo: '데리야끼 / 숯불구이 오징어 컷',
    nameJa: '照り焼き・直火焼き用カットイカ',
    scientificName: 'Photololigo edulis',
    category: 'squid',
    subCategory: 'Squid & Calamari',
  ...
  },
  {
    ...
    nameKo: '베트남 건오징어 (Export Dried Squid)',
    nameJa: 'ベトナム特選天然乾燥スルメイカ',
    scientificName: 'Photololigo edulis',
    category: 'squid',
    subCategory: 'Squid & Calamari',
  ...
  },
  {
    ...
    nameZh: '出口级卡文迪许香蕉 (鲜果)',
    nameKo: '베트남 카벤디쉬 바나나 (신선)',
    nameJa: 'ベトナム産キャベンディッシュバナナ（生果）',
  ...
  },
{
    ...
    nameKo: '베트남 깟쭈 / R2E2 망고 (신선)',
    nameJa: 'ベトナム産キャッチュー/R2E2マンゴー（生果）',
  ...
  },
{
    ...
    nameZh: '越南红心绿皮柚 (鲜果)',
    nameKo: '베트남 자몽 / 포멜로 (신선)',
    nameJa: 'ベトナム産緑皮ポメロ・文旦（生果）',
  ...
  },
{
    ...
    nameKo: '베트남 Ri6 / 몬통 두리안 (신선)',
    nameJa: 'ベトナム産Ri6/モントーンドリアン（生果）',
  ...
  },
{
    ...
    nameZh: '越南暹罗香水椰青 (鲜果)',
    nameKo: '베트남 코코넛 / 코코넛 워터 (신선)',
    nameJa: 'ベトナム産ヤシの実・ココナッツ（生果）',
  ...
  },
{
    ...
    nameZh: '越南无籽红肉西瓜 (鲜果)',
    nameKo: '베트남 씨없는 수박 (신선)',
    nameJa: 'ベトナム産種なしスイカ（生果）',
  ...
  },
{
    ...
    nameKo: '베트남 멜론 / 하미과 (신선)',
    nameJa: 'ベトナム産メロン・ハミ瓜（生果）',
  ...
  },
{
    ...
    nameKo: '베트남 사우어솝 / 구아바나 (신선)',
    nameJa: 'ベトナム産サワーソップ・刺果番荔枝（生果）',
  ...
  },
{
    ...
    nameZh: '越南牛奶果/星苹果 (鲜果)',
    nameKo: '베트남 스타애플 / 우유과 (신선)',
    nameJa: 'ベトナム産スターアップル・ミルクフルーツ（生果）',
  ...
  },
{
    ...
    nameZh: '越南莲雾/水蒲桃 (鲜果)',
    nameKo: '베트남 왁스애플 / 렌무 (신선)',
    nameJa: 'ベトナム産レンブ・レンブー（生果）',
  ...
  },
{
    ...
    nameKo: '베트남 아세로라 체리 (신선)',
    nameJa: 'ベトナム産アセロラチェリー（生果）',
  ...
  },
{
    ...
    nameKo: '베트남 라임 / 무씨 라임 (신선)',
    nameJa: 'ベトナム産種なしライム（生果）',
  ...
  },
{
    ...
    nameZh: '越南特级紫薯 (鲜果)',
    nameKo: '베트남 특급 자색고구마 (신선)',
    nameJa: 'ベトナム産特選紫サツマイモ（生果）',
  ...
  },
{
    ...
    nameZh: '越南彩椒/甜椒 (鲜椒)',
    nameKo: '베트남 파프리카 / 피망 (신선)',
    nameJa: 'ベトナム産パプリカ・ピーマン（生果）',
  ...
  },
{
    ...
    nameZh: '越南高良姜/南姜 (鲜姜)',
    nameKo: '베트남 갈랑갈 / 대강황 (신선)',
    nameJa: 'ベトナム産ナンキョウ・ガラangal（生果）',
  ...
  },
{
    ...
    nameZh: '冻干百香果纯粉',
    nameKo: '동결건조 패션후르츠 분말',
    nameJa: 'フリーズドライ パッションフルーツパウダー',
    category: 'powders',
  ...
  },
{
    ...
    nameZh: '冻干粉红番石榴粉',
    nameKo: '동결건조 핑크 구아바 분말',
    nameJa: 'フリーズドライ ピンクグアバパウダー',
    category: 'powders',
    subCategory: 'Freeze-Dried Powder',
    formats: ['80-100 Mesh'],
    specifications: {
  ...
  },
{
    ...
    nameZh: '冻干椰浆粉/椰子奶粉',
    nameKo: '동결건조 코코넛밀크 분말',
    nameJa: 'フリーズドライ ココナッツミルクパウダー',
    category: 'powders',
    subCategory: 'Freeze-Dried Powder',
  ...
  },
{
    ...
    nameZh: '红心火龙果浓缩萃取粉',
    nameKo: '레드용과 농축 추출 분말',
    nameJa: 'レッドドラゴンフルーツエキスパウダー',
    category: 'powders',
  ...
  },
{
    ...
    nameKo: '병풀 / 시카(Centella) 분말',
    nameJa: 'ツボクサ・CICAパウダー',
    category: 'powders',
    subCategory: 'Extract Powder',
    formats: ['100% Water Soluble Extract'],
    specifications: {
  ...
  },
{
    ...
    nameZh: '冻干特级山竹块/山竹果肉',
    nameKo: '동결건조 망고스틴 (Freeze-Dried)',
    nameJa: 'フリーズドライ マンゴスチン',
    scientificName: 'Garcinia mangostana',
  ...
  },
{
    ...
    nameZh: '冻干无核龙眼干/桂圆肉',
    nameKo: '동결건조 용안 / 롱간 (Freeze-Dried)',
    nameJa: 'フリーズドライ リュウガン',
    scientificName: 'Dimocarpus longan',
    category: 'freeze-dried',
    subCategory: 'Freeze-Dried Fruits',
  ...
  },
{
    ...
    nameZh: '冻干无核红毛丹块',
    nameKo: '동결건조 람부탄 (Freeze-Dried)',
    nameJa: 'フリーズドライ ランブータン',
    scientificName: 'Nephelium lappaceum',
    category: 'freeze-dried',
    subCategory: 'Freeze-Dried Fruits',
  ...
  },
{
    ...
    nameZh: '冻干无核荔枝果肉',
    nameKo: '동결건조 라이치 / 리치 (Freeze-Dried)',
    nameJa: 'フリーズドライ ライチ',
    scientificName: 'Litchi chinensis',
    category: 'freeze-dried',
    subCategory: 'Freeze-Dried Fruits',
  ...
  },
{
    ...
    nameZh: '冻干香酥椰子片',
    nameKo: '동결건조 코코넛 칩 (Freeze-Dried)',
    nameJa: 'フリーズドライ ココナッツチップ',
    scientificName: 'Cocos nucifera',
    category: 'freeze-dried',
    subCategory: 'Freeze-Dried Fruits',
  ...
  },
{
    ...
    nameZh: '冻干香蕉片/香蕉丁',
    nameKo: '동결건조 바나나 칩 (Freeze-Dried)',
    nameJa: 'フリーズドライ バナナ',
  ...
  },
{
    ...
    nameZh: '冻干金枕头榴莲脆片/榴莲块',
    nameKo: '동결건조 두리안 칩 (Freeze-Dried)',
    nameJa: 'フリーズドライ ドリアンチップ',
    scientificName: 'Durio zibethinus',
    category: 'freeze-dried',
    subCategory: 'Freeze-Dried Fruits',
  ...
  },
{
    ...
    nameZh: '冻干芒果脆片/芒果丁',
    nameKo: '동결건조 망고 다이스/칩 (Freeze-Dried)',
    nameJa: 'フリーズドライ マンゴーダイス',
    scientificName: 'Mangifera indica',
    category: 'freeze-dried',
    subCategory: 'Freeze-Dried Fruits',
  ...
  },
{
    ...
    nameKo: 'IQF 냉동 딸기 (원물 / 슬라이스)',
    nameJa: 'IQF 急速冷凍ストロベリー（ホール/スライス）',
    scientificName: 'Fragaria × ananassa',
    category: 'iqf',
  ...
  },
{
    ...
    nameZh: 'IQF 速冻薯条/薯丁',
    nameKo: 'IQF 냉동 감자 스트립/큐브',
    nameJa: 'IQF 急速冷凍ポテトカット',
  ...
  },
{
    ...
    nameKo: 'IQF 냉동 라이치 (씨 제거)',
    nameJa: 'IQF 急速冷凍ライチ（種抜き）',
    scientificName: 'Litchi chinensis',
    category: 'iqf',
    subCategory: 'IQF Fruits',
  ...
  },
{
    ...
    nameZh: 'IQF 速冻黄甜玉米粒',
    nameKo: 'IQF 냉동 스위트콘 알갱이',
    nameJa: 'IQF 急速冷凍スイートコーン',
  ...
  },
{
    ...
    nameKo: 'IQF 냉동 아보카도 큐브/하프',
    nameJa: 'IQF 急速冷凍アボカドカット',
    scientificName: 'Persea americana',
    category: 'iqf',
    subCategory: 'IQF Fruits',
  ...
  },
{
    ...
    nameKo: 'IQF 냉동 사우어솝 과육',
    nameJa: 'IQF 急速冷凍サワーソップ',
    scientificName: 'Annona muricata',
    category: 'iqf',
    subCategory: 'IQF Fruits',
  ...
  },
{
    ...
    nameKo: 'IQF 냉동 망고 다이스',
    nameJa: 'IQF 急速冷凍マンゴーダイス',
    scientificName: 'Mangifera indica',
    category: 'iqf',
    subCategory: 'IQF Fruits',
  ...
  },
{
    ...
    nameKo: 'IQF 냉동 파인애플 조각/큐브',
    nameJa: 'IQF 急速冷凍パイナップルカット',
    scientificName: 'Ananas comosus',
    category: 'iqf',
    subCategory: 'IQF Fruits',
  ...
  },
{
    ...
    nameZh: 'IQF 速冻红肉木瓜丁',
    nameKo: 'IQF 냉동 파파야 다이스',
    nameJa: 'IQF 急速冷凍パパイヤダイス',
    scientificName: 'Carica papaya',
    category: 'iqf',
    subCategory: 'IQF Fruits',
  ...
  },
{
    ...
    nameKo: 'IQF 냉동 두리안 과육',
    nameJa: 'IQF 急速冷凍ドリアン果肉',
    scientificName: 'Durio zibethinus',
    category: 'iqf',
    subCategory: 'IQF Fruits',
  ...
  },
{
    ...
    nameZh: 'IQF 速冻红心火龙果丁',
    nameKo: 'IQF 냉동 레드용과 다이스',
    nameJa: 'IQF 急速冷凍レッドドラゴンフルーツダイ스',
    scientificName: 'Hylocereus costaricensis',
    category: 'iqf',
    subCategory: 'IQF Fruits',
  ...
  },
{
    ...
    nameZh: '冻干针叶樱桃/维C纯粉',
    nameKo: '동결건조 아세로라 비타민C 분말',
    nameJa: 'フリーズドライ アセロラビタミンCパウダー',
  ...
  },
{
    ...
    nameKo: '베트남 로부스타 인스턴트 커피 분말',
    nameJa: 'ベトナム産ロブスタインスタントコーヒーパウダー',
  ...
  },
{
    ...
    nameKo: '고순도 커큐민 강황 추출 분말',
    nameJa: '高純度クルクミンウコンエキスパウダー',
    scientificName: 'Curcuma longa',
    category: 'powders',
    subCategory: 'Extract Powders',
  ...
  },
{
    ...
    nameZh: '蝶豆花天然蓝色色素粉',
    nameKo: '나비콩꽃(버터플라이피) 천연 청색 분말',
    nameJa: 'バタフライピー天然ブルーパウダー',
  ...
  // === PUREE, JUICE & CONCENTRATE PRODUCTS ===
  {
    ...
    nameZh: '冷冻无核榴莲果泥',
    nameKo: '냉동 씨제거 두리안 퓨레 (Puree)',
    nameJa: '冷凍種抜きドリアンピューレ（Puree）',
    scientificName: 'Durio zibethinus',
    category: 'purees',
  ...
  },
  {
    ...
    nameZh: '冷冻牛油果泥/牛油果糊',
    nameKo: '냉동 아보카도 퓨레 (Puree)',
    nameJa: '冷凍アボカドピューレ（Puree）',
    scientificName: 'Persea americana',
    category: 'purees',
    subCategory: 'Fruit Purees',
  ...
  },
  {
    ...
    nameZh: '冷冻红心火龙果泥',
    nameKo: '냉동 레드용과 퓨레 (Puree)',
    nameJa: '冷凍レッドドラゴンフルーツピューレ（Puree）',
    scientificName: 'Hylocereus costaricensis',
    category: 'purees',
    subCategory: 'Fruit Purees',
  ...
  },
  {
    ...
    nameKo: '냉동 사우어솝 퓨레 / 과육 (Puree)',
    nameJa: '冷凍サワーソップピューレ・果肉（Puree）',
    scientificName: 'Annona muricata',
    category: 'purees',
    subCategory: 'Fruit Purees',
  ...
  },
  {
    ...
    nameZh: '冷冻 Cat Chu 芒果泥',
    nameKo: '냉동 깟쭈 망고 퓨레 (Puree)',
    nameJa: '冷凍キャッチューマンゴーピューレ（Puree）',
    scientificName: 'Mangifera indica',
    category: 'purees',
    subCategory: 'Fruit Purees',
  ...
  },
  {
    ...
    nameZh: '冷冻菠萝浓缩汁/菠萝果泥',
    nameKo: '냉동 파인애플 퓨레 / 농축액',
    nameJa: '冷凍パイナップルピューレ・濃縮液',
    scientificName: 'Ananas comosus',
    category: 'purees',
    subCategory: 'Fruit Purees',
  ...
  },
  {
    ...
    nameKo: '냉동 착즙 패션후르츠 착즙액',
    nameJa: '冷凍ストレートパッションフルーツ果汁',
    scientificName: 'Passiflora edulis',
    category: 'purees',
    subCategory: 'Natural Juices',
  ...
  },
  {
    ...
    nameKo: '냉동 착즙 파인애플 착즙액',
    nameJa: '冷凍ストレートパイナップル果汁',
    scientificName: 'Ananas comosus',
    category: 'purees',
    subCategory: 'Natural Juices',
  ...
  },
  {
    ...
    nameZh: '无菌装浓缩椰子水',
    nameKo: '아셉틱 농축 코코넛 워터',
    nameJa: 'アセプティック濃縮ココナッツウォーター',
    scientificName: 'Cocos nucifera',
    category: 'purees',
  ...
  },
  {
    ...
    nameKo: '아셉틱 농축 파인애플 즙 (60-65 Brix)',
    nameJa: 'アセプティック濃縮パイナップル果汁',
    scientificName: 'Ananas comosus',
    category: 'purees',
    subCategory: 'Juice Concentrates',
  ...
  },
  {
    ...
    nameKo: '아셉틱 농축 패션후르츠 즙 (50 Brix)',
    nameJa: 'アセプティック濃縮パッションフルーツ果汁',
    scientificName: 'Passiflora edulis',
    category: 'purees',
    subCategory: 'Juice Concentrates',
  ...
  },
  {
    ...
    nameKo: '아셉틱 농축 망고 퓨레 (28-30 Brix)',
    nameJa: 'アセプティック濃縮マンゴーピューレ',
    scientificName: 'Mangifera indica',
    category: 'purees',
    subCategory: 'Juice Concentrates',
